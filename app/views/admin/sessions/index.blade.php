...
<div class="row">
    <div class="content">
        ...
        <blockquote class="bg-primary">
                    <p class="lead">Search Show</p>
        </blockquote>
            {{ Form::open(['route'=>'admin.show.search.postSession','method' => 'POST', 'accept-charset'=>'utf-8']) }}
...
<div class="row">
    <div class="content">
        ...
        <div class="col-md-10 well">
        <blockquote class="bg-primary">
              <p class="lead">All Sessions for <a href="{{ route('admin.shows.edit', $show->id) }}">{{ $show->name }}</a></p>
        </blockquote>
...
<script>
$(function(){
{{--        console.log({{ route('admin.show.search.ajax') }});--}}
        $('#show').autocomplete({
            source: "{{ route('admin.show.search.ajax') }}",
